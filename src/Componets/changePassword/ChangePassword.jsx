...
function ChangePassword() {
    ...
    const handleReadOnlyPassword=(event)=>{
        event.target.removeAttribute('readOnly')

    }
    const handleReadOnlyConfirmPassword=(event)=>{
        event.target.removeAttribute('readOnly')
    }
                                    ...
                                    <Container>
                                        <Row>
                                            <Col>
                                              ...
                                              <div  >
                                                    <input style={{width:'400px',height:'40px', borderRadius:'8px'}} readOnly type={inputType} value={values.newPassword} onChange={handleChange} onClick={handleReadOnlyPassword} placeholder='Enter The Password' onBlur={handleBlur} name='newPassword'></input>
                                               ...
                                               <label style={{height:'32px'}}> Confirm Password</label>
                                                <div  >
                                                    <input readOnly onClick={handleReadOnlyConfirmPassword} style={{width:'400px' ,height:'40px', borderRadius:'8px'}} placeholder='Enter The Confirm Password'  type={inputConfirmPasswordType} onChange={handleChange} onBlur={handleBlur} value={values.confirmPassword} name='confirmPassword'></input>
                                                    <span style={{position:'absolute',
                                                    marginTop:'-36px',
                                                     right:'25px',
                                                     zIndex:'10'}}>
