...
import { Card, Button, Container, Row, Col, Alert, InputGroup } from 'react-bootstrap'
                ...
                <Card.Text>
                  ...
                  >
                    <div style={{ padding: '2px' }}>
                      ...
                      <input placeholder='Enter The Email Id' style={{ width:  '420px',height:'40px', borderRadius:'8px' }} type='email' value={values.registrationEmail} onBlur={handleBlur} onChange={handleChange} name='registrationEmail' id="basic-addon3"></input>
                    <br></br>
                    ...
                    <div style={{ padding: '2px'}}>
                      ...
                      <div style={{display:'flex',marginLeft:'37px'}}>
                       <input placeholder='Enter the Password'
                         readOnly  onClick={handleRemove} style={{ width:  '420px',height:'40px', borderRadius:'8px' }}
                      type={inputType}
                        value={values.registraionPassword}
                         onBlur={handleBlur}  onChange={handleChange} name='registraionPassword'></input> 
