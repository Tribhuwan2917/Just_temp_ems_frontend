...
const[isSend,setIsSend]=useState(false)
  const { handleChange, handleBlur, handleSubmit, values,errors,touched } =
    useFormik({
      ...
      onSubmit: (values, action) => {
        ...
        values.receiverEmailId=location.state.employeeData.employeeEmail;
        console.log(values)
        axios
        .post(
  ...
  return (
    <div>
      ...
      {isSend?<span style={{margin:'3px',marginLeft:'-140px',paddingBottom:'100px'}}> We Are Sending The Email......
