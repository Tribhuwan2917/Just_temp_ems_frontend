...
function SignUp() {
  ...
  const handleRegistraionConfirmPassword=(event)=>{
    event.target.removeAttribute('readOnly')
  }
  const handleRegistraionPassword=(event)=>{
    event.target.removeAttribute('readOnly')
  }
  return (
    <div>
                ...
                <Card.Text>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <input placeholder="Enter The Password" readOnly onClick={handleRegistraionPassword} onBlur={handleBlur} style={{ width:  '420px',height:'40px', borderRadius:'8px' }} type={inputType} value={values.registraionPassword} onChange={handleChange} name='registraionPassword'></input>
                    ...
                    <div>
                      ...
                      <input placeholder="Enter The Confirm  Password" readOnly onClick={handleRegistraionConfirmPassword} onBlur={handleBlur} style={{ width:  '420px',height:'40px', borderRadius:'8px' }} type={inputConfirmPasswordType} value={values.registraionConfirmPassword} onChange={handleChange} name='registraionConfirmPassword'></input>
                      <span style={{position:'absolute',
                      marginTop:'5px',
                        right:'470px',
                        zIndex:'10'}}>
